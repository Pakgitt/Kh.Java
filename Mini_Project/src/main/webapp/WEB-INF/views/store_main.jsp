...
<head>
    ...
    <link rel="stylesheet" href="/mini/css/reset.css">
    <link rel="stylesheet" href="/mini/css/core.css">
    <link rel="stylesheet" href="/mini/css/layout.css">
    <link rel="stylesheet" href="/mini/css/store.css">
    <title>스토어메인2</title>
</head>
...
<body>
    <div class="header-wrap">
        <header>
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatum, illum quasi nemo omnis dolorum
                eveniet unde dignissimos exercitationem tenetur. Laboriosam suscipit quam magni facere enim maiores
                necessitatibus, id ea ullam!</p>
        </header>
    </div>
                    ...
                    <div class="store-main">
                        <div class="best-goods">
                            <a href="">
                                ...
                                <p class="img">
                                    <img src="/mini/img/meagapopup.jpg" alt="">
                                </p>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="flex-box">
                        ...
                        <div class="item">
                            <a href="#" class="item-a"> <!-- <div class="soldout">SOLD OUT</div> -->
                                ...
                                <div class="img">
                                    <img src="/mini/img/megaticket1.jpg" alt="">
                                </div>
                                <div class="info">
                                    <div class="tit">
                        ...
                        <div class="item">
                            <a href="#" class="item-a"> <!-- <div class="soldout">SOLD OUT</div> -->
                                ...
                                <div class="img">
                                    <img src="/mini/img/megaticket3.jpg" alt="">
                                </div>
                                <div class="info">
                                    <div class="tit">
                        ...
                        <div class="item">
                            <a href="#" class="item-a">
                                ...
                                <!-- <div class="lable event">EVENT</div> -->
                                <div class="img">
                                    <img src="/mini/img/megabutique.jpg" alt="">
                                </div>
                                <div class="info">
                                    <div class="tit">
                    ...
                    <div class="flex-box">
                        <div class="item">
                            <a href="#" class="item-a">
                                ...
                                <div class="img">
                                    <img src="/mini/img/megacombo.jpg" alt="">
                                </div>
                                <div class="info">
                                    <div class="tit">
                        ...
                        <div class="item">
                            <a href="#" class="item-a"> <!-- <div class="soldout">SOLD OUT</div> -->
                                <div class="lable new">NEW</div>
                                <div class="img">
                                    <img src="/mini/img/megasquid.jpg" alt="">
                                </div>
                                <div class="info">
                                    <div class="tit">
                        ...
                        <div class="item">
                            <a href="#" class="item-a">
                                ...
                                <div class="lable hot">대표상품</div>
                                <div class="img">
                                    <img src="/mini/img/megapop.jpg" alt="">
                                </div>
                                <div class="info">
                                    <div class="tit">
                                        <p class="name">러브콤보</p>
                    ...
                    <div class="flex-box">
                        ...
                        <div class="item">
                            <a href="#" class="item-a">
                                ...
                                <!-- <div class="lable event">EVENT</div> -->
                                <div class="img">
                                    <img src="/mini/img/megaticket2.jpg" alt="">
                                </div>
                                <div class="info">
                                    <div class="tit">
                        ...
                        <div class="item">
                            <a href="#" class="item-a">
                                ...
                                <!-- <div class="lable event">EVENT</div> -->
                                <div class="img">
                                    <img src="/mini/img/megacoupon1.jpg" alt="">
                                </div>
                                <div class="info">
                                    <div class="tit">
                        ...
                        <div class="item">
                            <a href="#" class="item-a">
                                ...
                                <div class="lable event">EVENT</div> -->
                                <div class="img">
                                    <img src="/mini/img/megacoupon2.jpg" alt="">
                                </div>
                                <div class="info">
                                    <div class="tit">
