...
<head>
    ...
    <link rel="stylesheet" href="/semi/css/board_faq.css">
</head>
    ...
    <div class="wrap-main">
        <div class="container">
            ...
            <div class="location">
                ...
                <dIiv class="location main"><span>메인이미지 > </span></dIiv>
            </div>
            <div class="subject">
                <div>FAQ</div>
            </div>
                        ...
                        <dl>
                            <dt>
                                <div class="text">
                                    ...
                                    <span class="title">
                                        <a href="#">별은 왜 망원경으로 봐도 점으로 보이나요?</a>
                                    </span>
                                    <span class="open active">ㅜ</span>
                                </div>
                            </dt>
                            <dd>
                                <div class="faq_detail">
                                    우리가 지구에서 관측되는 별 중에서 가장 크게 보이는 별은 바로 태양입니다.
                                    <br />
                                    <br />태양을 제외한 일반적으로 우리가 밤하늘에 관측되는 별들은 모두 점처럼 작게 보입니다.
                                    <br />
                                    <br />그 이유는 별의 크기에 비해 지구로부터 거리가 너무나도 멀리 떨어져 있기 때문입니다.
                                    <br />(※ 밤하늘의 별들중 지구에서 가장 가까운 대상은 켄타우르스자리의 프록시마이며, 4.2광년 떨어져있습니다. )
                                    <br />
                                    <br />태양계 내부에 있는 태양, 달, 행성 등은 우주 전체로 봤을 때 아주 가까운 거리에 있기 때문에
                                    <br />
                                    <br />망원경의 배율을 조절해 주면 크기가 커지기도 하고 작아지기도 합니다만 별은 그렇지 않습니다.
                                </div>
                            </dd>
                        </dl>
                        <dl>
